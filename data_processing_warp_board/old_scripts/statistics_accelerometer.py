...
def main():
  import argparse
  from accelerations import AccelerationsCalc
  ...
  mean_x, sd_x, iqr_x, skew_x, kurtosis_x = data_stats(accel_data.x_2_comp)
  mean_y, sd_y, iqr_y, skew_y, kurtosis_y = data_stats(accel_data.y_2_comp)
  mean_z, sd_z, iqr_z, skew_z, kurtosis_z = data_stats(accel_data.z_2_comp)
